...
The About & Experience system pairs a high-contrast profile card with a structured timeline for workplace, role, period, location, and responsibilities. The same managed history is reused on the About and résumé pages. Testimonials use large editorial quote cards when approved entries exist and a deliberate no-fabrication state when the collection is empty.

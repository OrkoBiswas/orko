...
- Added persisted navbar logo width sizing from 48–350px inside the Website logo panel, with navbar-height and mobile-width safety caps; the header permanently uses the logo alone without duplicate public-name text.

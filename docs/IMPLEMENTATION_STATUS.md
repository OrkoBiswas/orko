...
- Added persisted website logo width and height sizing from 20–200px inside the Website logo panel. Both dimensions can be adjusted independently while the artwork preserves its original proportions, and the header, footer, mobile menu, sticky filters, and first-screen spacing adapt safely around it.

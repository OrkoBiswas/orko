...
- Added persisted navbar logo sizing with a 28–64px control inside the Website logo panel; the header permanently uses the logo alone without duplicate public-name text.

...
export const metadata: Metadata = { title: "About", description: "About Orko Biswas, a multidisciplinary video editor, motion designer, and graphic designer." };

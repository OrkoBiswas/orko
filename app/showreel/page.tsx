...
export default function ShowreelPage() { return <>
  <PageHero index="05" eyebrow="Showreel" title={<>A quick look<br />at my <em>work.</em></>} intro="A short reel of video editing, motion graphics, titles, and campaign work. Final licensed clips and captions are being prepared. Sound will never start automatically." />
